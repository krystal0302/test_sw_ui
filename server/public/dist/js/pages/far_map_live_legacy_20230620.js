...
//     title: 'BBR',
//     model: 'FAR-BBR-250',
//     avatar: `${getImagePath()}/sprites/bbr-440x220.png`,
//     topview: `${getImagePath()}/sprites/bbr_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/bbr-150x150.png`,
//   },
//   smr1000: {
//     type: 'smr1000',
//     title: 'SMR 1000',
//     model: 'FAR-SMR-1000',
//     avatar: `${getImagePath()}/sprites/smr1000-440x220.png`,
//     topview: `${getImagePath()}/sprites/smr1000_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/smr1000-150x150.png`,
//   },
//   smr1000_300mm: {
//     type: 'smr1000',
//     title: 'SMR 1000',
//     model: 'FAR-SMR-1000',
//     avatar: `${getImagePath()}/sprites/smr1000_300mm-440x220.png`,
//     topview: `${getImagePath()}/sprites/smr1000_300mm_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/smr1000_300mm-150x150.png`,
//   },
//   smr250: {
//     type: 'smr250',
//     title: 'SMR 250',
//     model: 'FAR-SMR-250',
//     avatar: `${getImagePath()}/sprites/smr250-440x220.png`,
//     topview: `${getImagePath()}/sprites/smr250_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/smr250-150x150.png`,
//   },
//   smr250black: {
//     type: 'smr250',
//     title: 'SMR 250',
//     model: 'FAR-SMR-250',
//     avatar: `${getImagePath()}/sprites/smr250black-440x220.png`,
//     topview: `${getImagePath()}/sprites/smr250black_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/smr250black-150x150.png`,
//   },
//   hik600: {
//     type: 'hik',
//     title: 'HIK',
//     model: 'FAR-HIK',
//     avatar: `${getImagePath()}/sprites/hik-440x220.png`,
//     topview: `${getImagePath()}/sprites/hik_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/hik-150x150.png`,
//   },
//   mir250: {
//     type: 'mir',
//     title: 'MiR 250',
//     model: 'FAR-MiR-250',
//     avatar: `${getImagePath()}/sprites/mir-440x220.png`,
//     topview: `${getImagePath()}/sprites/mir_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/mir-150x150.png`,
//   },
//   none: {
//     type: 'smr1000',
//     title: 'SMR 1000',
//     model: 'FAR-SMR-1000',
//     avatar: `${getImagePath()}/sprites/smr1000_300mm-440x220.png`,
//     avatar: `${getImagePath()}/sprites/smr1000_300mm_topview-128x128.png`,
//     thumbnail: `${getImagePath()}/sprites/smr1000_300mm-150x150.png`,
//   },
// };
...
async function init() {
  ...
  try {
    await rmtTokenCheck();
    // scannedAgents = await fetchScanRobots(rmtToken_);
  } catch (err) {
    console.error(err);
  }
...
let apiQueryData_ = {};
// function pollHikForbiddenArea(_dataObj, _inteval = 1000) {
//   setInterval(async function () {
//     var res = await fetchHikForbiddenArea(rmtToken_);
//     // var json = await res.json();
//     // console.log(json);
//     if (res.ok) {
//       _dataObj['forbidden_area'] = await res.json();
//     }
//   }, _inteval);
// };

// function pollFleetStates(_dataObj, _inteval = 1000) {
//   setInterval(async function () {
//     var res = await fetchFleetStates(rmtToken_, currFleet_);
//     if (res.ok) {
//       _dataObj['fleet_state'] = await res.json();
//     }
//   }, _inteval);
// };
...
//   setInterval(async function () {
//     var res = await fetchWmsStates(rmtToken_, currMap_);
//     if (res.ok) {
...
// function pollPaths(_dataObj, _inteval = 1000) {
//   setInterval(async function () {
//     // var res = await fetchPaths(rmtToken_);
//     var res = await fetchPathMarkers(rmtToken_, currMap_);
//     if (res.ok) {
//       _dataObj['paths'] = await res.json();
//     }
//   }, _inteval);
// };

// function pollHikForbiddenArea2(_interval = 1000) {
//   $.ajax({
//     url: `http://${window.location.hostname}:5000/v2/hik/forbidden-area`,
//     type: "get",
//     dataType: "json",
//     timeout: _interval,
//     beforeSend: function (xhr) {
//       xhr.setRequestHeader("Authorization", `${rmtToken_.token_type} ${rmtToken_.access_token}`);
//     },
//     success: function (data) {
//       apiQueryData_['forbidden_area'] = data;
//     },
//     complete: function () {
//       pollHikForbiddenArea2();
//     }
//   });
// };

// function pollFleetStates2(_interval = 1000) {
//   var queryURL = (currFleet_ === '') ? '' : `?fleet_name=${currFleet_}&mode=position_only`;

//   $.ajax({
//     url: `http://${window.location.hostname}:5000/v2/fleets/status${queryURL}`,
//     type: "get",
//     dataType: "json",
//     timeout: _interval,
//     beforeSend: function (xhr) {
...
//     },
//     success: function (data) {
//       apiQueryData_['fleet_state'] = data;
//     },
//     complete: function () {
//       pollFleetStates2();
//     }
...
// function pollPaths2(_interval = 1000) {
//   $.ajax({
//     url: `http://${window.location.hostname}:5000/v2/paths/markers?ns=${currMap_}`,
//     type: "get",
//     dataType: "json",
//     timeout: _interval,
//     beforeSend: function (xhr) {
...
// function pollWmsStates2(_interval = 1000) {
//   let queryURL = (currMap_ === '') ? '' : `?map=${currMap_}&mode=load_only`;
//   $.ajax({
//     url: `http://${window.location.hostname}:5000/v2/wms${queryURL}`,
//     type: "get",
//     dataType: "json",
//     timeout: _interval,
//     beforeSend: function (xhr) {
...
function pollInternalLiveView(_interval = 1000) {
  let queryURL = (currFleet_ === '' || currMap_ === '') ? '' : `?fleet_name=${currFleet_}&map_name=${currMap_}`;
  $.ajax({
    url: `http://${window.location.hostname}:5000/v2/internal/live-view${queryURL}`,
    type: "get",
    dataType: "json",
    timeout: _interval,
    beforeSend: function (xhr) {
...
function drawVisFunctionalZone(_ctx, _obj) {
  ...
  for (key in _obj) {
    ...
    const fillColor = _obj[key].zone_type === 1 ? `rgba(144, 160, 196, ${opacity})` : `rgba(211, 170, 126, ${opacity})`;
